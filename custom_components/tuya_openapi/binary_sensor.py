...
BINARY_SENSORS: dict[str, tuple[TuyaBinarySensorEntityDescription, ...]] = {
    ...
    "wsdcg": (
        TuyaBinarySensorEntityDescription(
            key=DPCode.CHANNEL_0_ALARM,
            translation_key="ch0_alarm",
            name="ch0_alarm",
            on_value=1,
        ),
        TuyaBinarySensorEntityDescription(
            key=DPCode.CHANNEL_1_ALARM,
            translation_key="ch1_alarm",
            name="ch1_alarm",
            on_value=1,
        ),
        TuyaBinarySensorEntityDescription(
            key=DPCode.CHANNEL_2_ALARM,
            translation_key="ch2_alarm",
            name="ch2_alarm",
            on_value=1,
        ),
        TuyaBinarySensorEntityDescription(
            key=DPCode.CHANNEL_3_ALARM,
            translation_key="ch3_alarm",
            name="ch3_alarm",
            on_value=1,
        ),
        TuyaBinarySensorEntityDescription(
            key=DPCode.CHANNEL_4_ALARM,
            translation_key="ch4_alarm",
            name="ch4_alarm",
            on_value=1,
        ),
        TuyaBinarySensorEntityDescription(
            key=DPCode.CHANNEL_5_ALARM,
            translation_key="ch5_alarm",
            name="ch5_alarm",
            on_value=1,
        ),
        TuyaBinarySensorEntityDescription(
            key=DPCode.CHANNEL_6_ALARM,
            translation_key="ch6_alarm",
            name="ch6_alarm",
            on_value=1,
        ),
        TuyaBinarySensorEntityDescription(
            key=DPCode.CHANNEL_7_ALARM,
            translation_key="ch7_alarm",
            name="ch7_alarm",
            on_value=1,
        ),
        TuyaBinarySensorEntityDescription(
            key=DPCode.CHANNEL_8_ALARM,
            translation_key="ch8_alarm",
            name="ch8_alarm",
            on_value=1,
        ),
        TuyaBinarySensorEntityDescription(
            key=DPCode.CHANNEL_9_ALARM,
            translation_key="ch9_alarm",
            name="ch9_alarm",
            on_value=1,
        ),
        TuyaBinarySensorEntityDescription(
            key=DPCode.BEEP_STATUS,
            translation_key="beep_status",
            name="beep_status",
            on_value=1,
        ),
        TAMPER_BINARY_SENSOR,
